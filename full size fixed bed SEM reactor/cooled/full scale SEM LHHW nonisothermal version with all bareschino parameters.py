...
# --------------- DA isotherm parameters: Mette et al. (2014), used by Bareschino (2023) Table 1 ---
W0_DA = 341e-6              # micropore volume                     [m³/kg_sorbent]
E_DA  = 1192.25e3           # characteristic adsorption energy     [J/kg]
n_DA  = 1.55                # DA heterogeneity parameter           [-]

# --------------- Operating conditions ----------------------------------------
T_LIST = [280]                                  # inlet temperatures [°C]
...
def K_LDF_vec(T_K, p_arr, W0, E, n):
    ...
    return (0.1* 15.0 * eps_p * D_M
            / (0.5 * d_p**2 * tau_p * rho_p * R_gas * T_K * dqstar_dp))    #wrong dp**2, but bareschino did it this way
