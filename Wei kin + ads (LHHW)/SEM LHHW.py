...
m_cat   = 6.5e-3            # catalyst / sorbent mass             [kg]  (Wei Fig. 5.3, 5%Ni2.5%Ce13X)
...
A_mix   = 0.88              # K_mix pre-exponential               [bar^-1]
...
def reaction_rate_SI(T_K, p_CO2, p_H2, p_CH4, p_H2O):
    ...
    return r_g_s * 1000.0 * 0.8                               # → mol/(kg_cat·s) with effectivity factor of 0.8
...
ax.set_title(
    '5%Ni2.5%Ce13X  —  CO₂ methanation vs temperature\n'
