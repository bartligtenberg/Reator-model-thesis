...
bifuctional_mass = 0.32   # [kg]  mass of bifunctional 5%Ni-2.5%Ce/13X material
M_zeolite_added  = 0.924   # [kg]  additional pure 13X zeolite mixed in — 100% sorbent-active, 0% catalytically active (no Ni)
...
# --- MPB scan parameters ---
U_S_LIST  = np.array([8.0, 6.0, 5.0, 4.0, 3.0, 2.8, 2.6]) * 1e-3
T_IN_LIST = [280]
