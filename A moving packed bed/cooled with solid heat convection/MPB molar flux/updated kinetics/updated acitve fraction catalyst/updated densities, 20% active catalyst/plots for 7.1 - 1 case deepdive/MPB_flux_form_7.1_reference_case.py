...
ax.set_xlabel('z [m]', fontsize=16);  ax.set_ylabel('CO2 conversion [%]', fontsize=16)
...
ax1.set_xlabel('z [m]', fontsize=16);  ax1.set_ylabel('y_CH4 [mol%]  (primary axis)', color='tab:green', fontsize=16)
...
ax2.set_ylabel('minor species [mol%]  (secondary axis)', fontsize=16)
...
ax.set_xlabel('z [m]', fontsize=16);  ax.set_ylabel('H2O loading [mol/kg_ads]', fontsize=16)
ax.tick_params(labelsize=13)
...
ax.set_xlabel('z [m]', fontsize=16);  ax.set_ylabel('T [C]', fontsize=16)
ax.tick_params(labelsize=13)
ax.legend(fontsize=14);  ax.grid(True, alpha=0.3)
plt.tight_layout()
...
ax1.set_xlabel('z [m]', fontsize=16);  ax1.set_ylabel('r [mmol/(kg_cat·s)]', color='tab:purple', fontsize=16)
...
ax2.set_ylabel('CO2 conversion [%]', color='tab:blue', fontsize=16)
...
lines1, labels1 = ax1.get_legend_handles_labels()
lines2, labels2 = ax2.get_legend_handles_labels()
ax1.legend(lines1+lines2, labels1+labels2, fontsize=14, loc='center right')
ax1.grid(True, alpha=0.3)
plt.tight_layout()
...
fig, axA = plt.subplots(figsize=(8, 5.5))
...
axA.set_xlabel('z [m]', fontsize=16);  axA.set_ylabel('local volumetric rate [kW/m³]', fontsize=16)
...
fig, axB = plt.subplots(figsize=(8, 5.5))
...
axB.set_xlabel('z [m]', fontsize=16);  axB.set_ylabel('cumulative sensible heat picked up [W]', fontsize=16)
axB.tick_params(labelsize=13)
axB.legend(fontsize=14);  axB.grid(True, alpha=0.3)
plt.tight_layout()
...
ax.set_ylabel('heat rate [W]', fontsize=16)
ax.tick_params(labelsize=13)
...
ax.set_xlabel('z [m]', fontsize=16);  ax.set_ylabel('$K_{LDF}$ [1/s]', fontsize=16)
ax.set_yscale('log')
ax.tick_params(labelsize=13)
ax.legend(fontsize=14);  ax.grid(True, which='both', alpha=0.3)
plt.tight_layout()
